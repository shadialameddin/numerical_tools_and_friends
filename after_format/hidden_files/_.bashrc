...
export GPG_TTY=$(tty) # to do with gpg signature

# export MATLAB_ROOT=/backup/z_packages/matlab/bin
...
########################################### latex
# export TEXINPUTS=.:/backup/emma/slides//:/backup/emma/templates//:

# export ANDROID_SDK=/packages/flutter/android-sdk
